...
// Add settings
/// RW needed to change to get_template_directory() for child theme!

include( get_stylesheet_directory(). '/inc/theme-options/theme-colors.php' );
include( get_stylesheet_directory() . '/inc/theme-options/typography.php' );
include( get_stylesheet_directory() . '/inc/theme-options/layout.php' );
include( get_stylesheet_directory() . '/inc/theme-options/static-frontpage.php' );
include( get_stylesheet_directory() . '/inc/theme-options/blog-home.php' );
